...
public:  
    ...
    constexpr static const float MAX_X =  1.0f;
    constexpr static const float MIN_X = -1.0f;
    constexpr static const float MAX_Y =  1.0f;
    constexpr static const float MIN_Y = -1.0f;

    constexpr static const float DIF_X = 2.0f; // MAX_X - MIN_X;
    constexpr static const float DIF_Y = 2.0f; // MAX_Y - MIN_Y;

    constexpr static const float BOTTOM = -1.0f;
