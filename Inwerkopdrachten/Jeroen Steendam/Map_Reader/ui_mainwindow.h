...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        if (MainWindow->objectName().isEmpty())
            MainWindow->setObjectName(QStringLiteral("Algemeen Inwerken"));
        ...
        verticalLayoutWidget->setGeometry(QRect(10, 10, 461, 421));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Map Reader", 0));
