...
public:
    ...
    void setupUi(QDialog *EditMapWindow)
    {
        ...
        lineButton = new QRadioButton(EditMapWindow);
        lineButton->setObjectName(QStringLiteral("lineButton"));
        lineButton->setGeometry(QRect(630, 100, 82, 17));
        rectangleButton = new QRadioButton(EditMapWindow);
        rectangleButton->setObjectName(QStringLiteral("rectangleButton"));
        rectangleButton->setGeometry(QRect(630, 130, 82, 17));
        circleButton = new QRadioButton(EditMapWindow);
        circleButton->setObjectName(QStringLiteral("circleButton"));
        circleButton->setGeometry(QRect(630, 160, 82, 17));
    ...
    void retranslateUi(QDialog *EditMapWindow)
    {
        ...
        lineButton->setText(QApplication::translate("EditMapWindow", "Line", 0));
        rectangleButton->setText(QApplication::translate("EditMapWindow", "Rectangle", 0));
        circleButton->setText(QApplication::translate("EditMapWindow", "Circle", 0));
    } // retranslateUi
