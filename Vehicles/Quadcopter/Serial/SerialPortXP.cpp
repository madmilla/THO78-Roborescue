...
SerialLinux::SerialLinux(const char* deviceName) 
{ 
...
int SerialLinux::writeData(char* data, int nrOfBytes)
{
...
int SerialLinux::readData(char* buffer, int nrOfBytes)
{
...
SerialWindows::SerialWindows(const char* deviceName):
	connected{ false },
	errors{ 0 }
{
...
int SerialWindows::readData(char* buffer, int nrOfBytes)
{
	DWORD bytesRead;
	unsigned int toRead;
...
int SerialWindows::writeData(char* data, int nrOfBytes)
{
	DWORD bytesSend;
