...
macro(find_VTK)
  ...
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "/usr/lib64/cmake/vtk-6.1")
  endif(PCL_ALL_IN_ONE_INSTALLER AND NOT ANDROID)
  if(NOT ANDROID)
    find_package(VTK ${QUIET_})
    if (VTK_FOUND)
      set(VTK_LIBRARIES "vtkRenderingLIC;vtkIOLegacy;vtkCommonDataModel;vtkCommonMath;vtkCommonCore;vtksys;vtkCommonMisc;vtkCommonSystem;vtkCommonTransforms;vtkIOCore;vtkCommonExecutionModel;/usr/lib64/libz.so;vtkIOXML;vtkIOGeometry;/usr/lib64/libjsoncpp.so;vtkIOXMLParser;/usr/lib64/libexpat.so;vtkImagingSources;vtkImagingCore;vtkRenderingOpenGL;vtkImagingHybrid;vtkIOImage;vtkDICOMParser;vtkmetaio;/usr/lib64/libjpeg.so;/usr/lib64/libpng.so;/usr/lib64/libtiff.so;vtkRenderingCore;vtkFiltersExtraction;vtkFiltersCore;vtkFiltersGeneral;vtkCommonComputationalGeometry;vtkFiltersStatistics;vtkImagingFourier;vtkalglib;vtkFiltersGeometry;vtkFiltersSources;vtkFiltersParallelImaging;vtkFiltersImaging;vtkImagingGeneral;vtkFiltersParallel;vtkFiltersModeling;vtkParallelCore;vtkftgl;/usr/lib64/libfreetype.so;vtkWrappingPythonCore;/usr/lib/libpython2.7.so;vtkWrappingTools;vtkTestingGenericBridge;vtkFiltersVerdict;verdict;vtkexoIIc;vtkNetCDF;vtkNetCDF_cxx;/usr/lib64/libhdf5.so;/usr/lib64/libhdf5_hl.so;/usr/lib64/libpthread.so;/usr/lib64/libdl.so;/usr/lib64/libm.so;vtkFiltersSelection;vtkImagingStatistics;vtkFiltersParallelGeometry;vtkParallelMPI;vtkFiltersParallelFlowPaths;vtkFiltersAMR;vtkFiltersFlowPaths;vtkIOGeoJSON;vtkIOParallelNetCDF;vtkImagingMath;vtkInteractionWidgets;vtkFiltersHybrid;vtkInteractionStyle;vtkRenderingAnnotation;vtkImagingColor;vtkRenderingFreeType;vtkRenderingVolume;vtkIOEnSight;vtkIOMPIParallel;vtkRenderingFreeTypeFontConfig;vtkFiltersGeneric;vtkFiltersParallelMPI;vtkIOExport;vtkRenderingContext2D;vtkRenderingGL2PS;vtkgl2ps;vtkRenderingLabel;vtkFiltersParallelStatistics;vtkViewsCore;VPIC;vtkTestingIOSQL;vtkIOSQL;vtksqlite;vtkRenderingImage;vtkViewsInfovis;vtkChartsCore;vtkCommonColor;vtkInfovisCore;vtkInfovisLayout;vtkImagingStencil;vtkFiltersReebGraph;vtkIOExodus;vtkDomainsChemistry;vtkIOMPIImage;vtkRenderingMatplotlib;vtkPythonInterpreter;vtkIOLSDyna;vtkIOMySQL;vtkIOMINC;vtkRenderingVolumeOpenGL;vtkWrappingJava;vtkImagingMorphological;vtkRenderingFreeTypeOpenGL;vtkViewsQt;vtkGUISupportQt;vtkIOFFMPEG;vtkIOMovie;/usr/lib64/libtheoraenc.so;/usr/lib64/libtheoradec.so;/usr/lib64/libogg.so;vtkLocalExample;vtkRenderingQt;vtkFiltersTexture;vtkGUISupportQtOpenGL;vtkTestingRendering;vtkGUISupportQtSQL;vtkIOGDAL;vtkViewsGeovis;vtkGeovisCore;vtkproj4;vtkIOInfovis;/usr/lib64/libxml2.so;vtkRenderingParallelLIC;vtkInfovisBoostGraphAlgorithms;vtkIOVideo;vtkFiltersSMP;vtkIOParallel;vtkIONetCDF;vtkIOImport;vtkViewsContext2D;vtkIOAMR;vtkRenderingParallel;vtkRenderingLOD;vtkIOParallelExodus;vtkIOXdmf2;vtkxdmf2;vtkIOPLY;vtkRenderingVolumeAMR;vtkGUISupportQtWebkit;vtkIOVPIC;vtkIOParallelLSDyna;vtkIOPostgreSQL;vtkFiltersHyperTree;vtkInteractionImage;vtkIOODBC;vtkFiltersProgrammable")
    endif(VTK_FOUND)
  endif()
endmacro(find_VTK)
